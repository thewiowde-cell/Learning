...
with open("scrap_tutorial-master/lesson1/blank/index.html", encoding='utf-8') as file:
    src = file.read()
# print(src)
...
# user_name = soup.find(
#     'div', {'class': "user__name", 'id': 'aaa'}).find('span').text
# print(user_name)
...
#     class_="post__date").find_previous_sibling().find_next().text
# print(post_title)
...
#     link_href_attrl = link['href']

#     link_data_attr = link.get('data-attr')
#     link_data_attrl = link['data-attr']
#     print(link_href_attrl)
#     print(link_data_attrl)
